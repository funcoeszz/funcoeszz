...
Possui as consoantes: c l m p r
O verbo escrito ao contrário: ralipmoc
$

$ zzdicportugues falar
v.reg.mult.Expressar-se através das palavras; dizer: falou mentiras; falou mentiras aos pais; quase nunca falava; não se falavam.
...
Expressar-se numa outra língua: fala espanhol com perfeição.v.t.i.Falar mal de; criticar: fala sempre da vizinha.v.pron.Permanecer em contato com alguém: os pais não se falam.s.m.Ato de se expressar, de conversar: não ouço o falar do professor.
...
[Figurado]Vulgar. Possuir sexualmente outra pessoa.v.pron.Consumir-se por: comia-se de raiva!v.i.Alimentar-se habitualmente: não como em restaurantes.
Provar pela primeira vez; experimentar: comer da maçã proibida.
[Figurado]Carcomer, roer, consumir: a ferrugem come o ferro.
[Figurado]Eliminar ou ganhar pedras em jogo de tabuleiro.s.m.Ação de comer; aquilo que se come ou ingere; alimento: o comer não lhe satisfaz.
