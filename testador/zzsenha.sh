...
$ zzsenha	--num	--uniq	11	#→ O tamanho máximo desse tipo de senha é 10
$ zzsenha	--uniq	--num	11	#→ O tamanho máximo desse tipo de senha é 10
...
$ zzsenha	--pro	--uniq	75	#→ --regex ^[A-Za-z0-9/:;()$&@.,?!-]{75}$
$ zzsenha	--pro	--uniq		#→ --regex ^[A-Za-z0-9/:;()$&@.,?!-]{8}$
$ zzsenha	--uniq	--pro	0
$ zzsenha	--uniq	--pro	1	#→ --regex ^[A-Za-z0-9/:;()$&@.,?!-]$
$ zzsenha	--uniq	--pro	75	#→ --regex ^[A-Za-z0-9/:;()$&@.,?!-]{75}$
$ zzsenha	--uniq	--pro		#→ --regex ^[A-Za-z0-9/:;()$&@.,?!-]{8}$
